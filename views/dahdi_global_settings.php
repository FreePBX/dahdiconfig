...
<div id="global">
    ...
    <h3>This edits all settings in chan_dahdi.conf</h3>
    <hr />
        ...
        <tr>
            ...
            <td>
                <select id="language" name="language">
            		...
            		<option value="es" <?php echo set_default($dahdi_cards->get_globalsettings('language'),'es'); ?>>Spanish</option>
            		...
            		<option value="gr" <?php echo set_default($dahdi_cards->get_globalsettings('language'),'gr'); ?>>Greek</option>
            		...
            		<option value="il" <?php echo set_default($dahdi_cards->get_globalsettings('language'),'il'); ?>>Israeli Hebrew</option>
            		...
            		<option value="za" <?php echo set_default($dahdi_cards->get_globalsettings('language'),'za'); ?>>South African</option>
            		...
            		<option value="ar" <?php echo set_default($dahdi_cards->get_globalsettings('language'),'ar'); ?>>Argentine Spanish</option>
