    ...
    <tr>
        <td class="mfcr2-label">
            <label class="mfcr2-label" for="editspan_<?php echo $key?>_mfcr2_variant">
				<a href="#" class="info"><?php echo _('MFC/R2 Variant')?>:
					<span>
						<?php echo ("MFC/R2 variant, this depends on the OpenR2 supported variants. A list of values can be found by executing the openr2 command `r2test -l`") ?>
					</span>
				</a>
			</label>
        </td>
        <td>
           	<select id="editspan_<?php echo $key?>_mfcr2_variant" name="editspan_<?php echo $key?>_mfcr2_variant">
	    		<option value="AR"	<?php echo set_default($span['mfcr2_variant'], 'AR') ?>>Argentina</option>
	    		<option value="BR"  <?php echo set_default($span['mfcr2_variant'], 'BR') ?>>Brazil</option>
	    		<option value="CN"	<?php echo set_default($span['mfcr2_variant'], 'CN') ?>>China</option>
	    		<option value="CZ"	<?php echo set_default($span['mfcr2_variant'], 'CZ') ?>>Czech Republic</option>
	    		<option value="CO"	<?php echo set_default($span['mfcr2_variant'], 'CO') ?>>Colombia</option>
	    		<option value="EC"	<?php echo set_default($span['mfcr2_variant'], 'EC') ?>>Ecuador</option>
	    		<option value="ID"	<?php echo set_default($span['mfcr2_variant'], 'ID') ?>>Indonesia</option>
	    		<option value="ITU"	<?php echo set_default($span['mfcr2_variant'], 'ITU') ?>>International Telecommunication Union</option>
	    		<option value="MX"	<?php echo set_default($span['mfcr2_variant'], 'MX') ?>>Mexico</option>
	    		<option value="PH"	<?php echo set_default($span['mfcr2_variant'], 'PH') ?>>Philippines</option>
	    		<option value="VE"	<?php echo set_default($span['mfcr2_variant'], 'VE') ?>>Venezuela</option>
        	</select>
        </td>
    </tr>
    <tr>
    	<td class="mfcr2-label">
    		<label class="mfcr2-label" for="editspan_<?php echo $key?>_mfcr2_max_ani">
    			<a href="#" class="info"><?php echo _('Max ANI') ?>:
					<span>
						<?php echo ("Max amount of ANI to ask for<br /> <strong>Default:</strong>10"); ?>
					</span>
    			</a>
    		</label>
    	</td>
    	...
    	<td class="mfcr2-label">
    		<label class="mfcr2-label" for="editspan_<?php echo $key?>_mfcr2_max_dnis">
    			<a href="#" class="info"><?php echo _('Max DNIS') ?>:
					<span>
						<?php echo ("Max amount of DNIS to ask for<br /> <strong>Default:</strong>4"); ?>
					</span>
    			</a>
    		</label>
    	</td>
    ...
    <tr>
    	<td>
    		<label class="mfcr2-label" for="editspan_<?php echo $key?>_mfcr2_get_ani_first">
    			<a href="#" class="info"><?php echo _('Get ANI Before DNIS'); ?>:
    				<span>
    					<?php echo ("Determine whether or not to get the ANI before getting DNIS.  Some telcos require ANI first some others do not care.<br /> <strong>Default:</strong>no"); ?>
    				</span>
				</a>
			</label>
    	</td>
    	<td>
			<select id="editspan_<?php echo $key?>_mfcr2_get_ani_first" name="editspan_<?php echo $key?>_mfcr2_get_ani_first">
                ...
                <option value="no" <?php echo set_default($span['mfcr2_get_ani_first'],'no'); ?>><?php echo ('No')?></option>
                <option value="yes" <?php echo set_default($span['mfcr2_get_ani_first'],'yes'); ?>><?php echo ('Yes')?></option>
            </select>
    	</td>
    </tr>
    <tr>
    	<td>
    		<label class="mfcr2-label" for="editspan_<?php echo $key?>_mfcr2_category">
    			<a href="#" class="info"><?php echo _('Caller Category to Send'); ?>:
    				<span>
    					<?php echo ("Usually national_subscriber works just fine.  You can also change this setting from the dialplan by setting the variable MFCR2_CATEGORY (remember to set _MFCR2_CATEGORY from originating channels). <br />MFCR2_CATEGORY will also be a variable available in your context on incoming calls set to the value received from the far end.<br /> <strong>Default:</strong>national_subscriber"); ?>
    				</span>
				</a>
			</label>
    	</td>
    	<td>
			<select id="editspan_<?php echo $key?>_mfcr2_category" name="editspan_<?php echo $key?>_mfcr2_category">
                <option value="national_subscriber" <?php echo set_default($span['mfcr2_category'],'national_subscriber'); ?>><?php echo ('national_subscriber') ?></option>
                <option value="national_priority_subscriber" <?php echo set_default($span['mfcr2_category'],'national_priority_subscriber'); ?>><?php echo ('national_priority_subscriber')?></option>
                <option value="international_subscriber" <?php echo set_default($span['mfcr2_category'],'international_subscriber'); ?>><?php echo ('international_subscriber')?></option>
                <option value="international_priority_subscriber" <?php echo set_default($span['mfcr2_category'],'international_priority_subscriber'); ?>><?php echo ('international_priority_subscriber')?></option>
                <option value="collect_call" <?php echo set_default($span['mfcr2_category'],'collect_call'); ?>><?php echo ('collect_call')?></option>
            </select>
    	</td>
    </tr>
    <tr>
        <td>
            <label class="mfcr2-label" for="editspan_<?php echo $key?>_mfcr2_logdir">
                <a href="#" class="info"><?php echo _('Call Logging Directory'); ?>:
                    <span>
                        <?php echo ("Logging is stored at the Asterisk logging directory specified in asterisk.conf plus mfcr2/<whatever you put here>. If you specify 'span1' here and asterisk.conf has as logging directory /var/log/asterisk then the full path to your MFC/R2 call logs will be /var/log/asterisk/mfcr2/span1 (the directory will be automatically created if not present already)"); ?>
                    </span>
                </a>
            </label>
        </td>
    ...
    <tr>
    	<td>
    		<label class="mfcr2-label" for="editspan_<?php echo $key?>_mfcr2_call_files">
    			<a href="#" class="info"><?php echo _('Call Logging Enable'); ?>:
    				<span>
    					<?php echo ("Determine whether or not to drop call files into mfcr2_logdir. (see tooltip under Call Loggin Directory. <br /> Default: no"); ?>
    				</span>
				</a>
			</label>
    	</td>
    	<td>
			<select id="editspan_<?php echo $key?>_mfcr2_call_files" name="editspan_<?php echo $key?>_mfcr2_call_files">
                ...
                <option value="no" <?php echo set_default($span['mfcr2_call_files'],'no'); ?>><?php echo ('No')?></option>
                <option value="yes" <?php echo set_default($span['mfcr2_call_files'],'yes'); ?>><?php echo ('Yes')?></option>
            </select>
    	</td>
    </tr>
    <tr>
    	...
    	<td>
    		<label class="mfcr2-label" for="editspan_<?php echo $key?>_mfcr2_mfback_timeout">
    			<a href="#" class="info"><?php echo _('MF Timeout'); ?>:
    				<span>
    					<?php echo ("MFC/R2 value in milliseconds for the MF timeout. <br />Any negative value means 'default', smaller values than 500ms are not recommended and can cause malfunctioning. <br />If you experience protocol error due to MF timeout try incrementing this value in 500ms steps<br /> <strong>Default:</strong>-1"); ?>
    				</span>
				</a>
			</label>
    	</td>
    ...
    <tr>
    	...
    	<td>
			<select id="editspan_<?php echo $key?>_mfcr2_allow_collect_calls" name="editspan_<?php echo $key?>_mfcr2_allow_collect_calls">
                ...
                <option value="no" <?php echo set_default($span['mfcr2_allow_collect_calls'],'no'); ?>><?php echo ('No')?></option>
                <option value="yes" <?php echo set_default($span['mfcr2_allow_collect_calls'],'yes'); ?>><?php echo ('Yes')?></option>
            </select>
    	</td>
    </tr>
    <tr>
        ...
        <td>
            <select id="editspan_<?php echo $key?>_mfcr2_double_answer" name="editspan_<?php echo $key?>_mfcr2_double_answer">
                ...
                <option value="no" <?php echo set_default($span['mfcr2_double_answer'],'no'); ?>><?php echo ('No')?></option>
                <option value="yes" <?php echo set_default($span['mfcr2_double_answer'],'yes'); ?>><?php echo ('Yes')?></option>
            </select>
        </td>
    </tr>
    <tr>
    	<td>
    		<label class="mfcr2-label" for="editspan_<?php echo $key?>_mfcr2_immediate_accept">
    			<a href="#" class="info"><?php echo _('Immediate Accept'); ?>:
    				<span>
    					<?php echo ("This feature allows to skip the use of Group B/II signals and go directly to the accepted state for incoming calls.<br /> <strong>Default:</strong>no"); ?>
    				</span>
				</a>
			</label>
    	</td>
    	<td>
			<select id="editspan_<?php echo $key?>_mfcr2_immediate_accept" name="editspan_<?php echo $key?>_mfcr2_immediate_accept">
                ...
                <option value="no" <?php echo set_default($span['mfcr2_immediate_accept'],'no'); ?>><?php echo ('No')?></option>
                <option value="yes" <?php echo set_default($span['mfcr2_immediate_accept'],'yes'); ?>><?php echo ('Yes')?></option>
            </select>
    	</td>
    </tr>
    <tr>
    	...
    	<td>
			<select id="editspan_<?php echo $key?>_mfcr2_accept_on_offer" name="editspan_<?php echo $key?>_mfcr2_accept_on_offer">
                ...
                <option value="no" <?php echo set_default($span['mfcr2_accept_on_offer'],'no'); ?>><?php echo ('No')?></option>
                <option value="yes" <?php echo set_default($span['mfcr2_accept_on_offer'],'yes'); ?>><?php echo ('Yes')?></option>
            </select>
    	</td>
    </tr>
    <tr>
    	<td>
    		<label class="mfcr2-label" for="editspan_<?php echo $key?>_mfcr2_skip_category">
    			<a href="#" class="info"><?php echo _('Skip Category'); ?>:
    				<span>
    					<?php echo ("Skips request of calling party category and ANI. <br />You need openr2 >= 1.2.0 to use this feature<br /> <strong>Default:</strong>no"); ?>
    				</span>
				</a>
			</label>
    	</td>
    	<td>
			<select id="editspan_<?php echo $key?>_mfcr2_skip_category" name="editspan_<?php echo $key?>_mfcr2_skip_category">
                ...
                <option value="no" <?php echo set_default($span['mfcr2_skip_category'],'no'); ?>><?php echo ('No')?></option>
                <option value="yes" <?php echo set_default($span['mfcr2_skip_category'],'yes'); ?>><?php echo ('Yes')?></option>
            </select>
    	</td>
    </tr>
	<tr>
    	...
    	<td>
			<select id="editspan_<?php echo $key?>_mfcr2_forced_release" name="editspan_<?php echo $key?>_mfcr2_forced_release">
                ...
                <option value="no" <?php echo set_default($span['mfcr2_forced_release'],'no'); ?>><?php echo ('No')?></option>
                <option value="yes" <?php echo set_default($span['mfcr2_forced_release'],'yes'); ?>><?php echo ('Yes')?></option>
            </select>
    	</td>
    </tr>
    <tr>
    	...
    	<td>
			<select id="editspan_<?php echo $key?>_mfcr2_charge_calls" name="editspan_<?php echo $key?>_mfcr2_charge_calls">
                ...
                <option value="no" <?php echo set_default($span['mfcr2_charge_calls'],'no'); ?>><?php echo ('No')?></option>
                <option value="yes" <?php echo set_default($span['mfcr2_charge_calls'],'yes'); ?>><?php echo ('Yes')?></option>
            </select>
    	</td>
    </tr>
    <tr>
    	<td>
    		<label class="mfcr2-label" for="editspan_<?php echo $key?>_mfcr2_advanced_protocol_file">
    			<a href="#" class="info"><?php echo _('Advanced Protocol Configuration File'); ?>:
    				<span>
    					<?php echo ("<strong>WARNING:</strong> advanced users only as it allows you custom define tone definitions used in the protocol! <br /> This parameter is commented by default because YOU DON'T NEED IT UNLESS YOU REALLY UNDERSTAND MFC/R2!"); ?>
    				</span>
				</a>
			</label>
    	</td>
